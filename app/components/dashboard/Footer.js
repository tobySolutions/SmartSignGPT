...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/SmartSignGPT');
            ...
            <div className="flex items-center gap-2 pt-8">
              ...
              <div className="flex items-center">
                <Image
                  ...
                  height={20}
                />
                <span className="text-xl font-semibold ml-2 leading-none font-sans text-black">
                  metaschool
                </span>
              </div>
            </div>
